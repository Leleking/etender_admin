<template>
    <div>
      ...
      <div class="page-content vertical-align-middle">
        <header>
          <h1 class="animation-slide-top">About Us</h1>
          <p style="text-align:justify">Lorem ipsum Voluptate ad et culpa ad eu ex nulla voluptate nostrud consectetur
                            ...
                            aliqua elit est aliqua labore eiusmod.</p>
        </header>
        <p class="error-advise">Get the best of the best</p>
        <router-link to="/" class="btn btn-dark btn-round" href="../index.html">LETS GET SHOPPING</router-link>
